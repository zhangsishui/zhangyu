    ...
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
        <fieldset >
            ...
            <div class="control-group success">
                ...
                <div class="controls">
                    <input class="input-xlarge focused" id="focusedInput" type="text" value="{{old("title",$active->title)}}" name="title">
                </div>
            </div>
            <div class="control-group success">
                <label class="control-label">活动开始时间</label>
                <div class="controls">
                    <input type="date" class="input-xlarge focused" name="start_time" value="{{old("start_time",$active->start_time)}}">
                </div>
            </div>
            <div class="control-group success">
                <label class="control-label">活动截止时间</label>
                <div class="controls">
                    <input type="date" class="input-xlarge focused" name="end_time" value="{{old("end_time",$active->end_time)}}">
                </div>
            </div>
