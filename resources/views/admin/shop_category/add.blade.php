...
@section("content")
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="inputEmail3" placeholder="分类名称" name="name" value="{{old("name")}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label">简介</label>
            <div class="col-sm-8">
                <input type="intro" class="form-control" id="inputPassword3" placeholder="简介" name="intro" value="{{old("intro")}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label">是否显示</label>
            <div class="col-sm-8">
                <input type="radio" id="status" name="status" checked value="1">显示
                <input type="radio" id="status" name="status" value="0">隐藏
            </div>
        </div>
        <div class="form-group">
